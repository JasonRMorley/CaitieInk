...
def login():
    ...
    if request.method == "POST":
        ...
        if username in ADMIN_USERNAME and check_password_hash(os.getenv('ADMIN_PASSWORD'), password):
            session["user"] = username
            return redirect(url_for("route_home"))
        elif username in GUEST_USERNAME and check_password_hash(os.getenv('guest_password'), password):
            session["user"] = username
            return redirect(url_for("route_home"))
